...
public class SSNEnrollPatch {
	...
	@PatchMapping("/ssnEnrollmentPatch/{id}")
	public ResponseEntity<?> partialUpdateName(@RequestBody Author enroll, @PathVariable("id") int id) {

		enroll.setAuthorId(id);
		int ssn = service.saveAuthor(enroll);

		String msg = "Data patch success!!! id is :- " + ssn;
